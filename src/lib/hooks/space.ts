...
export function useCreateSpace(
    options?: Omit<MutationOptions<Space | undefined, DefaultError, Prisma.SpaceCreateArgs>, 'mutationFn'>,
...
export function useCreateManySpace(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SpaceCreateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    const _mutation = useModelMutation<Prisma.SpaceCreateManyArgs, DefaultError, Prisma.BatchPayload, false>(
        'Space',
        'POST',
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.SpaceCreateManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.SpaceCreateManyArgs>>,
                'mutationFn'
            >,
        ) => {
...
export function useUpdateSpace(
    options?: Omit<MutationOptions<Space | undefined, DefaultError, Prisma.SpaceUpdateArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManySpace(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SpaceUpdateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.SpaceUpdateManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.SpaceUpdateManyArgs>>,
                'mutationFn'
            >,
        ) => {
            return (await value.mutateAsync(args, options as any)) as Prisma.BatchPayload;
...
export function useUpsertSpace(
    options?: Omit<MutationOptions<Space | undefined, DefaultError, Prisma.SpaceUpsertArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteSpace(
    options?: Omit<MutationOptions<Space | undefined, DefaultError, Prisma.SpaceDeleteArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteManySpace(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SpaceDeleteManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.SpaceDeleteManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.SpaceDeleteManyArgs>>,
                'mutationFn'
            >,
        ) => {
            return (await value.mutateAsync(args, options as any)) as Prisma.BatchPayload;
