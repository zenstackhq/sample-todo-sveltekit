...
export function useCreateUser(
    options?: Omit<MutationOptions<User | undefined, DefaultError, Prisma.UserCreateArgs>, 'mutationFn'>,
...
export function useCreateManyUser(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserCreateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.UserCreateManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.UserCreateManyArgs>>,
                'mutationFn'
            >,
        ) => {
...
export function useUpdateUser(
    options?: Omit<MutationOptions<User | undefined, DefaultError, Prisma.UserUpdateArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useUpdateManyUser(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserUpdateManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.UserUpdateManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.UserUpdateManyArgs>>,
                'mutationFn'
            >,
        ) => {
            return (await value.mutateAsync(args, options as any)) as Prisma.BatchPayload;
...
export function useUpsertUser(
    options?: Omit<MutationOptions<User | undefined, DefaultError, Prisma.UserUpsertArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteUser(
    options?: Omit<MutationOptions<User | undefined, DefaultError, Prisma.UserDeleteArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
...
export function useDeleteManyUser(
    options?: Omit<MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserDeleteManyArgs>, 'mutationFn'>,
    invalidateQueries: boolean = true,
    optimisticUpdate: boolean = false,
) {
    const { endpoint, fetch } = getHooksContext();
    ...
    const mutation = derived(_mutation, (value) => ({
        ...
        mutateAsync: async <T extends Prisma.UserDeleteManyArgs>(
            ...
            options?: Omit<
                MutationOptions<Prisma.BatchPayload, DefaultError, Prisma.SelectSubset<T, Prisma.UserDeleteManyArgs>>,
                'mutationFn'
            >,
        ) => {
            return (await value.mutateAsync(args, options as any)) as Prisma.BatchPayload;
